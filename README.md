...
The second time I starded from the ground and planned the whole architecture myself. I drawed all the schemes, all the planned features and every component. Then I formulated the folders structure and how to group the algorithms. Finally I elaborated the first prompt. It took me a while and it was very precise. I defined the folder and file structure, I made a standard for data files and whole hierarchy.
...
Dealing with the structure and planning made the project a lot better. Cursor can trun ideas into executale code but it cannot solve the architecture problems.

---

#### Project capabilities:
- discover open ports
- conduct tests to define what service in running on port
- display all gathered knowledge and service name

Manned services: (more coming in future)
- Ollama
- Nvidia Triton
- Nvidia Prometheus
- Qdrant
